...
import heart
from pygame import event,display,image
...
matched=image.load('new_assist/matched.png')


running= True
tiles=[heart.hearts(i) for i in range(0,gc.NUM_TILES_TOTAL)]
current_images=[]
while running:
